...
describe('dialer/recycle', () => {
  ...
  context('with a campaign with recycle and max_call_attempts set', () => {
    let campaign, callee;
    beforeEach(async() => campaign = await Campaign.query().insert({name: 'test', recycle: true, max_call_attempts: 2}));
